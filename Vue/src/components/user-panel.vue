<template>
  <div class="user-panel ">
    <div class="user-info">
      ...
      <div class="user-name dx-theme-text-color">{{ email }}</div>
    </div>
    ...
    >
      <DxPosition>
        <DxMy value="top center"/>
        <DxAt value="bottom center"/>
      </DxPosition>
    </DxContextMenu>
...
import DxContextMenu, { DxPosition, DxMy, DxAt } from 'devextreme-vue/context-menu';
